            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="javascript:void(0)"
                        ...
                        <x-avatar :name="auth()->user()->name" :email="auth()->user()->email" />
                    </a>
                </li>
                <li>
                ...
                <li>
                    <x-nav-item :url="'#'" label="Events" :active="request()->is('events*')">
                ...
                <li>
                    <form
                      ...
                      method="POST" action="{{ route('logout') }}">
                        ...
                        <button class="flex w-full hover:bg-gray-100 dark:hover:bg-gray-700 items-center p-2 text-gray-900 rounded-lg dark:text-white group">
                            <svg
                            class="w-5 h-5 transition duration-75 text-red-500"
